...
// to test the code console.log(greetUser('Jillian'))
...
// to test the code console.log(canWeDeliver(48301))
...
// CODE HERE
//write a new function using some sort of loop
...
// console.log(canWeDeliverTwo(48301))
...
const newDeals2 = deals[1].desc.replace('March','April');
